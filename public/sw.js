const CACHE_NAME = 'the-network-v2';
...
self.addEventListener('push', (event) => {
  ...
  const { title = 'The Network', body = '', icon = '/icons/icon-192x192.png', badge = '/icons/icon-72x72.png', url = '/', tag = 'default', data: extraData = {} } = data;
